...
export class ConversationController {
    ...
    async getConversation(
        ...
        try {
            ...
            console.log('ConversationController - getConversation() error', exception.message);
            throw error(exception.message);
        }
    }
    ...
    async deleteConversation(
        ...
        try {
            ...
            ).catch(err => console.error('Background deleteConversation error:', err));
    ...
    async leaveConversation(
        ...
        try {
            ...
            // Run in background as requested
            this.conversationService.leaveConversation(userId, conversationObjectId)
                .catch(err => console.error('Background leaveConversation error:', err));
    ...
    async getParticipants(@Param('conversationId') conversationId: string) {
        const conversationObjectId = new ObjectId(conversationId);
        const participants = await this.conversationService.getParticipants(conversationObjectId);
    ...
    async getMessages(@Param('conversationId') conversationId: string) {
        const conversationObjectId = new ObjectId(conversationId);
        const messages = await this.conversationService.getMessages(conversationObjectId);
        return success(`Message from conversation ${conversationObjectId}`, messages);
    }
    ...
    async joinConversation(
        ...
        try {
            const conversationObjectId = new ObjectId(conversationId);
            await this.conversationService.joinConversation(conversationObjectId, joinConversationDto);
